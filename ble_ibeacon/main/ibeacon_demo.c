...
static void esp_gap_cb(esp_gap_ble_cb_event_t event, esp_ble_gap_cb_param_t *param)
{
    ...
    ESP_LOGI(DEMO_TAG, "esp_gap_cb: 0x%x", event);

    switch (event) {
    case ESP_GAP_BLE_ADV_DATA_RAW_SET_COMPLETE_EVT:{
        ESP_LOGI(DEMO_TAG, "ESP_GAP_BLE_ADV_DATA_RAW_SET_COMPLETE_EVT");
    ...
    case ESP_GAP_BLE_SCAN_RESULT_EVT: {
        ...
        ESP_LOGI(DEMO_TAG, "ESP_GAP_BLE_SCAN_RESULT_EVT: 0x%x", scan_result->scan_rst.search_evt);
