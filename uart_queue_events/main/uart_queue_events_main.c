...
static const char *TAG = "uart_queue_events";
...
static void uart_tx_task(void *pvParameters)
{
    ...
    for(;;)
    {
        ESP_LOGI(TAG, "uart write~");
        uart_write_bytes(EX_UART_NUM, (const char*) txData, sizeof(txData));
...
void app_main()
{
    ...
    xTaskCreate(uart_tx_task, "uart_tx_task", 2048, NULL, configMAX_PRIORITIES, NULL);
}
